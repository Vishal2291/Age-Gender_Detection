...
import os
outPath = r"G:\ML Project\PreRequisites\Resizing\New"
path = "G:\ML Project\PreRequisites\Resizing\TestImages"
...
for image_path in os.listdir(path):
    ...
    age = yearTaken-dob
    fullpath = os.path.join(outPath, image_path.split('_')[0]+'_'+str(age)+'.jpg')
    img.save(fullpath)